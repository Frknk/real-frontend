...
import { CreateBrandModal } from "./brand-create-modal"
...
export function BrandsListTable() {
    const { data, isLoading, isError } = useQuery({ queryKey: ['brands'], queryFn: getBrands, refetchInterval: 10000, refetchOnWindowFocus: true })
